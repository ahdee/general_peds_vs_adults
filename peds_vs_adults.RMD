...
est = readRDS(  paste0( "/ehome/resource/public/treehouse/v11/v11.estimate.immuno.rds"))
...
#est_plot =  reshape2::melt ( as.matrix(v11[gthis, ]) )

imm = ggplot(est2, aes(y=ImmuneScore, x=age_group)) +
    geom_violin()+ 
...
g= reshape2::  melt ( v11_tpm["CD274", v11_age_noleuk$th_sampleid ] ) # CTLA4
colnames  ( g) = c("tube", "tpm")

est3 = merge ( est2, g, by.x = "Row.names", by.y = "tube")
...
g= reshape2::  melt ( v11_tpm["CTLA4", v11_age_noleuk$th_sampleid ] ) # CTLA4
colnames  ( g) = c("tube", "tpm")
